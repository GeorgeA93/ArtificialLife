...
public class InteractiveLayer extends MapLayer{
            ...
            for(int x = 0; x < width; x ++) {
                if (tiles[x + y * width] == Tile.NULL_TILE) {
                    ...
                    if(( random.nextInt(600) > 598) && ((y + 2) < height) &&
                            tiles[x + y * width] == Tile.NULL_TILE &&
                            Map.foregroundLayer.getTileAt(x, y + 1) == Tile.NULL_TILE){
                        generateLongRock(x, y);
                    }
                    if(( random.nextInt(30) > 28) && ((x + 2) < width) && ((y + 3) < height) &&
                            tiles[(x + 1) + y * width] == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x, y + 1) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x + 1, y + 1) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x + 2, y + 1) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x, y + 2) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x + 1, y + 2) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x + 2, y + 2) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x, y + 3) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x + 1, y + 3) == Tile.NULL_TILE &&
                            map.foregroundLayer.getTileAt(x + 2, y + 3) == Tile.NULL_TILE ){
                        generateTree(x, y);
                    }
    ...
    private void generateLongRock(int xx, int yy){
        ...
        map.foregroundLayer.addTile(xx, yy + 1, Tile.LONG_ROCK_TOP);
    }

    private void generateTree(int xx, int yy){
        map.shadowLayer.addTile(xx, yy, Tile.tree_bottom_left);
        tiles[(xx + 1) + yy * width] = Tile.tree_bottom_middle;
        map.shadowLayer.addTile(xx + 2, yy, Tile.tree_bottom_right);
        map.foregroundLayer.addTile(xx, yy + 1, Tile.tree_bottom_rmiddle_left);
        map.foregroundLayer.addTile(xx + 1, yy + 1, Tile.tree_bottom_rmiddle);
        map.foregroundLayer.addTile(xx + 2, yy + 1, Tile.tree_bottom_rmiddle_right);
        map.foregroundLayer.addTile(xx, yy + 2, Tile.tree_top_rmiddle_left);
        map.foregroundLayer.addTile(xx + 1, yy + 2, Tile.tree_top_rmiddle);
        map.foregroundLayer.addTile(xx + 2, yy + 2, Tile.tree_top_rmiddle_right);
        map.foregroundLayer.addTile(xx, yy + 3, Tile.tree_top_left);
        map.foregroundLayer.addTile(xx + 1, yy + 3, Tile.tree_top_middle);
        map.foregroundLayer.addTile(xx + 2, yy + 3, Tile.tree_top_right);
    }

    private void generateDeadTree(int xx, int yy){
        map.shadowLayer.addTile(xx, yy, Tile.tree_dead_bottom_left);
        tiles[(xx + 1) + yy * width] = Tile.tree_dead_bottom_middle;
        map.shadowLayer.addTile(xx + 2, yy, Tile.tree_dead_bottom_right);
        map.foregroundLayer.addTile(xx , yy + 1, Tile.tree_dead_bottom_rmiddle_left);
        map.foregroundLayer.addTile(xx + 1, yy + 1, Tile.tree_dead_bottom_rmiddle);
        map.foregroundLayer.addTile(xx + 2, yy + 1, Tile.tree_dead_bottom_rmiddle_right);
        map.foregroundLayer.addTile(xx , yy + 2, Tile.tree_dead_top_rmiddle_left);
        map.foregroundLayer.addTile(xx + 1, yy + 2, Tile.tree_dead_top_rmiddle);
        map.foregroundLayer.addTile(xx + 2, yy + 2, Tile.tree_dead_top_rmiddle_right);
        map.foregroundLayer.addTile(xx , yy + 3, Tile.tree_dead_top_left);
        map.foregroundLayer.addTile(xx + 1, yy + 3, Tile.tree_dead_top_middle);
        map.foregroundLayer.addTile(xx + 2, yy + 3, Tile.tree_dead_top_right);
    }
